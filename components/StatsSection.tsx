...
export default function StatsSection() {
  ...
  const getIcon = (id: string) => {
    switch (id) {
      ...
      case "pass-rate":
        return <CheckCircle2 size={22} className="text-blue-500 group-hover:scale-110 smooth-transition" />;
      case "universities":
        return <School size={22} className="text-blue-500 group-hover:scale-110 smooth-transition" />;
      case "cert-instructors":
        return <Award size={22} className="text-blue-500 group-hover:scale-110 smooth-transition" />;
      default:
