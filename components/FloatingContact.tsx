...
import { Phone, Sparkles, Brain } from "lucide-react";
    ...
    <>
      ...
      <div className="fixed bottom-6 right-6 z-40 flex flex-col gap-2.5 items-end">
        ...
        <button
          ...
          className="flex items-center gap-2 bg-gradient-to-r from-indigo-600 via-purple-600 to-blue-600 hover:from-indigo-500 hover:to-blue-500 text-white px-3.5 py-2.5 rounded-full shadow-xl hover:scale-105 transition-all duration-300 group cursor-pointer border border-white/20"
          aria-label="AI Tư Vấn Lộ Trình"
        >
          <div className="w-6 h-6 rounded-full bg-white/20 flex items-center justify-center text-cyan-300 font-black text-xs shrink-0 group-hover:rotate-12 transition-transform">
            <Brain size={14} className="text-cyan-300 animate-pulse" />
          </div>
          <span className="text-xs font-black pr-1 hidden sm:inline-block">AI Lộ Trình Đỗ 100%</span>
        </button>
