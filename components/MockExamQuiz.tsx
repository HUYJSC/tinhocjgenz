...
export default function MockExamQuiz() {
  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-200/90 shadow-lg p-6 sm:p-10 max-w-4xl mx-auto relative overflow-hidden font-sans">
      ...
      {!gradingResult ? (
        <div className="space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 pb-5">
            <div>
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold uppercase bg-blue-50 text-blue-700 border border-blue-100 mb-2">
          ...
          <div className="space-y-5 pt-2">
            <div className="flex items-center gap-2">
              <span className="px-2.5 py-0.5 rounded-lg text-xs font-bold uppercase bg-blue-100 text-blue-800">
                {currentQ.subject}
              </span>
          ...
          <div className="flex items-center justify-between gap-3 pt-6 border-t border-slate-100">
            ...
            <button
              ...
              className="min-h-12 px-5 sm:px-6 py-3 rounded-xl bg-slate-900 hover:bg-blue-600 disabled:opacity-40 disabled:cursor-not-allowed text-white text-xs font-bold tracking-wide uppercase shadow-md hover:shadow-lg transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer"
            >
              {isSubmitting ? (
                <>
        ...
        <div className="space-y-8 animate-fade-in text-center">
          ...
          {/* Score Box */}
          <div className={`p-6 sm:p-8 rounded-2xl border max-w-md mx-auto ${
            ...
            <div className="mt-3 inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-white shadow-sm">
              {gradingResult.passed ? (
                <>
                ...
                {gradingResult.skillAnalysis.map((sk, idx) => (
                  <div key={idx} className="space-y-1">
                    <div className="flex justify-between text-xs font-bold text-slate-700">
                      ...
                      <span className={sk.percent >= 80 ? "text-blue-600" : sk.percent >= 50 ? "text-blue-600" : "text-red-600"}>
                    ...
                    <div className="w-full bg-slate-200 h-2 rounded-full overflow-hidden">
                      <div
                        className={`h-full rounded-full transition-all ${
                          sk.percent >= 80 ? "bg-blue-500" : sk.percent >= 50 ? "bg-blue-500" : "bg-red-500"
                        }`}
          ...
          {!isSubmittedLead ? (
            <div className="bg-slate-900 text-white p-6 sm:p-8 rounded-2xl max-w-xl mx-auto space-y-4 shadow-md text-left">
              ...
              <button
                ...
                className="w-full py-3.5 rounded-xl bg-blue-400 text-slate-950 font-bold text-xs uppercase tracking-wide shadow-lg hover:scale-[1.01] transition-all flex items-center justify-center gap-2 cursor-pointer"
              >
                <Send size={14} />
