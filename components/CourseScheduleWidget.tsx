...
import { Calendar, Clock, CheckCircle2, ArrowRight, MessageSquare, Laptop, ShieldCheck } from "lucide-react";
...
export default function CourseScheduleWidget({ courseTitle, batches }: Props) {
  ...
  return (
    <div className="bg-white p-6 sm:p-7 rounded-2xl border border-slate-200/90 shadow-premium space-y-6">
      ...
      {!isCustom1on1 ? (
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <span
                      className={`px-2 py-0.5 rounded-full text-xs font-bold tracking-tight shrink-0 ${
                  ...
                  <div className="space-y-1 pt-1.5 border-t border-slate-200/60">
                    <div className="flex items-center justify-between text-xs font-bold text-slate-500">
                      ...
                      <span className="text-blue-600 font-extrabold">Còn lại: {batch.slotsRemaining} / {batch.slotsTotal} chỗ</span>
                    </div>
                    <div className="w-full bg-slate-200 h-1.5 rounded-full overflow-hidden">
                      <div
                        className={`h-full rounded-full transition-all duration-200 ${
                          batch.slotsRemaining <= 2 ? "bg-blue-500" : "bg-blue-600"
                        }`}
                  ...
                  {isSelected && (
                    <div className="pt-2 flex items-center gap-2">
                      <button
                        ...
                        className="flex-1 py-2 px-3 rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold uppercase tracking-wider flex items-center justify-center gap-1.5 shadow-sm transition-all cursor-pointer"
                      >
        ...
        <div className="p-5 rounded-2xl bg-blue-50 border border-blue-200/80 space-y-4">
          <div className="flex items-start gap-3">
            <div className="p-2.5 rounded-xl bg-blue-600 text-white shrink-0">
              <Laptop size={18} />
            </div>
            <div className="space-y-1">
              <h4 className="font-bold text-sm text-slate-900">Kèm 1:1 Theo Khung Giờ Riêng Của Bạn</h4>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="w-full py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold uppercase tracking-wider flex items-center justify-center gap-2 shadow-sm transition-all"
          >
