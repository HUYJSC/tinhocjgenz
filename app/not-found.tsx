...
import { Home, BookOpen, Award, FileSpreadsheet, PhoneCall } from "lucide-react";
import { SITE_CONFIG } from "@/data/siteConfig";

export default function NotFound() {
  return (
    <div className="min-h-[75vh] flex items-center justify-center bg-slate-50/60 px-4 py-16">
      <div className="max-w-2xl w-full text-center space-y-8 bg-white p-8 sm:p-12 rounded-2xl border border-slate-200 shadow-md">
        <div className="space-y-3">
          <span className="text-6xl sm:text-7xl font-bold text-transparent bg-clip-text bg-blue-600">
            404
          </span>
