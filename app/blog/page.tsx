...
import { Sparkles, Search, BookOpen, Award, Zap, ArrowRight, Clock, Eye, Tag, ChevronRight, TrendingUp, ShieldCheck } from "lucide-react";
...
export default function BlogPage() {
  ...
  return (
    <div className="flex flex-col w-full bg-slate-50/50 min-h-screen">
      ...
      <section className="bg-white pt-24 pb-14 border-b border-slate-100 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center space-y-4">
          ...
          <h1 className="text-3xl sm:text-5xl font-bold text-slate-900 tracking-tight leading-tight font-display max-w-3xl mx-auto">
            ...
            {BLOG_CATEGORIES.map((cat) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold whitespace-nowrap transition-all duration-300 cursor-pointer ${
                    isActive
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 space-y-12">
        ...
        {selectedCategory === "all" && !searchQuery && featuredPost && (
          <div className="bg-white rounded-2xl border border-slate-200/90 shadow-premium overflow-hidden hover:border-blue-500/40 transition-all duration-300">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-0">
              ...
              <div className="lg:col-span-7 relative min-h-[260px] sm:min-h-[340px] overflow-hidden group">
                ...
                <div className="absolute top-4 left-4">
                  <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider bg-blue-500 text-white shadow-md">
                    <TrendingUp size={12} />
              ...
              <div className="lg:col-span-5 p-6 sm:p-8 flex flex-col justify-between space-y-6">
                <div className="space-y-4">
                  ...
                  <Link href={`/blog/${featuredPost.slug}`} className="group block">
                    <h2 className="text-xl sm:text-2xl font-bold text-slate-900 group-hover:text-blue-600 transition-colors leading-snug font-display">
                      {featuredPost.title}
                    </h2>
                  </Link>
                ...
                <div className="pt-4 border-t border-slate-100 flex items-center justify-between">
                  ...
                  <Link
                    ...
                    className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full text-xs font-bold uppercase tracking-wider bg-blue-600 hover:bg-blue-700 text-white transition-all shadow-md group"
                  >
                    <span>Đọc Tiếp</span>
          ...
          {filteredPosts.length === 0 ? (
            <div className="bg-white rounded-2xl p-12 text-center border border-slate-200/80 space-y-4">
              ...
              <button
                ...
                className="px-5 py-2.5 rounded-full bg-blue-600 text-white text-xs font-bold uppercase tracking-wider"
              >
                  ...
                  <div>
                    ...
                    <Link href={`/blog/${post.slug}`} className="block relative h-48 overflow-hidden">
                      <NextImage
                        ...
                        className="object-cover group-hover:scale-105 transition-transform duration-500"
                      />
                      <span className="absolute top-3 left-3 px-2.5 py-1 rounded-lg text-xs font-bold uppercase tracking-wider bg-slate-900/80 backdrop-blur-md text-white border border-white/20">
                        {post.categoryName}
                      </span>
                    </Link>
                    ...
                    <div className="p-6 space-y-3.5">
                      ...
                      <Link href={`/blog/${post.slug}`} className="block group/link">
                        <h4 className="text-base sm:text-lg font-bold text-slate-900 group-hover/link:text-blue-600 transition-colors leading-snug font-display line-clamp-2">
                          {post.title}
                        </h4>
                      </Link>
        ...
        <section className="bg-blue-950 text-white rounded-2xl p-8 sm:p-12 relative overflow-hidden shadow-lg">
          ...
          <div className="relative z-10 max-w-2xl space-y-4 text-center sm:text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 pt-2">
              <Link
                href="/lien-he"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-7 py-3 rounded-full text-xs font-bold uppercase tracking-wider bg-blue-600 hover:bg-blue-500 text-white shadow-lg transition-all"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-7 py-3 rounded-full text-xs font-bold uppercase tracking-wider bg-white/10 hover:bg-white/20 border border-white/20 text-white transition-all"
              >
