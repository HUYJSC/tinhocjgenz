...
import { Award, CheckCircle2, Clock, ShieldCheck, ArrowRight, School, ArrowLeft, BookOpen, Star, HelpCircle, GraduationCap } from "lucide-react";
...
export default async function CourseDetailPage(props: CoursePageProps) {
  ...
  return (
    <div className="flex flex-col w-full bg-slate-50/40 font-sans">
      ...
      <section className="bg-blue-950 text-white pt-10 pb-12 sm:pt-20 sm:pb-16 relative overflow-hidden border-b border-slate-800">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="mb-6">
            <Link
              href="/khoa-hoc"
              className="inline-flex items-center gap-1.5 text-xs font-bold text-slate-400 hover:text-blue-300 transition-colors"
            >
              <ArrowLeft size={14} />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-8 space-y-5">
              ...
              <div className="flex flex-wrap items-center gap-2">
                {course.badge && (
                  <span className="px-3.5 py-1 rounded-full text-xs font-bold bg-blue-500/20 text-blue-300 border border-blue-400/30 flex items-center gap-1">
                    <Star size={12} className="fill-blue-400 text-blue-400" />
                    {course.badge}
                  </span>
                )}
                {course.examCode && (
                  <span className="px-3.5 py-1 rounded-full text-xs font-mono font-bold bg-blue-500/20 text-blue-300 border border-blue-400/30">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 pt-4 border-t border-slate-800/80">
                <div className="space-y-1">
                  <span className="text-xs uppercase font-bold tracking-wider text-slate-400">Thời lượng học</span>
                ...
                <div className="space-y-1">
                  <span className="text-xs uppercase font-bold tracking-wider text-slate-400">Tỷ lệ đỗ Certiport</span>
                ...
                <div className="space-y-1 col-span-2 sm:col-span-1">
                  <span className="text-xs uppercase font-bold tracking-wider text-slate-400">Hình thức đào tạo</span>
                  <div className="text-sm font-bold text-white flex items-center gap-1.5">
            ...
            <div className="lg:col-span-4">
              <div className="bg-white text-slate-900 rounded-2xl p-6 sm:p-8 shadow-lg border border-slate-200 space-y-6">
                <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-8 space-y-10">
              ...
              {course.syllabus && course.syllabus.length > 0 ? (
                <div className="space-y-6">
                  {course.syllabus.map((item) => (
                    <div
                      key={item.session}
                      className="p-6 sm:p-7 rounded-2xl bg-slate-50/70 border border-slate-200/80 hover:border-blue-500/30 transition-all duration-300 space-y-3 relative group"
                    >
              ...
              <div className="p-6 sm:p-8 rounded-2xl bg-slate-900 text-white space-y-4 border border-slate-800">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="text-xs font-bold uppercase text-blue-400 tracking-wider">ĐỘI NGŨ ĐÀO TẠO</span>
                    <h3 className="text-lg font-bold text-white">Giảng Viên MOS Master Trainer</h3>
              ...
              <div className="p-6 sm:p-8 rounded-2xl bg-blue-900 text-white space-y-4 shadow-md">
            ...
            <div className="lg:col-span-4 space-y-6">
              ...
              {course.targetAudience && (
                <div className="bg-slate-50/80 p-6 rounded-2xl border border-slate-200/80 space-y-2">
                  <h4 className="text-xs font-bold uppercase tracking-wider text-slate-400">Đối tượng phù hợp:</h4>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {courseReviews.map((rev) => (
              <div key={rev.id} className="p-6 rounded-2xl bg-white border border-slate-200 shadow-sm space-y-4">
                <div className="flex items-center justify-between">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {relatedCourses.map((rel) => (
                <div key={rel.id} className="p-6 rounded-2xl bg-white border border-slate-200 hover:border-blue-500 shadow-sm transition-all space-y-3 flex flex-col justify-between">
                  <div className="space-y-2">
                    <span className="text-xs font-bold uppercase text-blue-600">{rel.duration}</span>
                  ...
                  <div className="pt-3 border-t border-slate-100 flex items-center justify-between">
                    <span className="font-bold text-blue-600 text-sm">{rel.price}</span>
                    <Link
