...
import { ArrowRight, School, BookOpen, Clock, ChevronRight, Sparkles, CheckCircle2, ShieldCheck, Award } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <div className="flex flex-col w-full bg-white">
      ...
      <section className="py-12 sm:py-16 bg-blue-950 text-white relative overflow-hidden border-y border-slate-800">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-4 flex flex-col sm:flex-row lg:flex-col gap-3 justify-center">
              <Link
                href="/thi-thu"
                className="w-full min-h-12 py-3.5 px-6 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs sm:text-sm tracking-wide uppercase shadow-lg transition-all text-center flex items-center justify-center gap-2 cursor-pointer"
              >
              ...
              <Link
                href="/tai-lieu"
                className="w-full min-h-12 py-3.5 px-6 rounded-xl bg-slate-900/80 hover:bg-slate-900 text-slate-300 hover:text-white font-bold text-xs sm:text-sm border border-slate-700 transition-all text-center flex items-center justify-center gap-2"
              >
                <BookOpen size={15} />
      ...
      <section id="dang-ky-tu-van" className="py-14 sm:py-20 bg-slate-50 border-t border-slate-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          <div className="text-center space-y-3">
            ...
            <h2 className="text-2xl sm:text-4xl font-bold text-slate-900 tracking-tight font-display">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4 text-center">
            <div className="p-4 rounded-xl bg-white border border-slate-200 shadow-xs space-y-1">
              <ShieldCheck size={20} className="text-blue-600 mx-auto" />
              <h4 className="text-xs font-bold text-slate-900">Cam Kết Bao Đỗ 100%</h4>
              <p className="text-[11px] text-slate-500">Tài trợ học lại hoàn toàn miễn phí nếu chưa đạt điểm chuẩn</p>
            </div>
            <div className="p-4 rounded-xl bg-white border border-slate-200 shadow-xs space-y-1">
              <School size={20} className="text-blue-600 mx-auto" />
              <h4 className="text-xs font-bold text-slate-900">Chuẩn Khảo Thí Quốc Tế</h4>
              <p className="text-[11px] text-slate-500">Cấp tài khoản máy ảo luyện đề Certiport không giới hạn</p>
            </div>
            <div className="p-4 rounded-xl bg-white border border-slate-200 shadow-xs space-y-1">
              <Clock size={20} className="text-blue-600 mx-auto" />
              <h4 className="text-xs font-bold text-slate-900">Hỗ Trợ 1:1 Tận Tâm</h4>
              <p className="text-[11px] text-slate-500">Giảng viên Master Trainer kèm cặp và sửa bài trực tiếp</p>
            </div>
          </div>
