...
export default function AboutPage() {
  const values = [
    ...
    },
    {
      ...
      icon: <Heart className="text-blue-500 group-hover:scale-110 smooth-transition" size={20} />
    },
    {
      ...
      icon: <Sparkles className="text-blue-500 group-hover:scale-110 smooth-transition" size={20} />
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="relative w-full max-w-sm aspect-[4/5] rounded-2xl bg-blue-950 shadow-sm overflow-hidden p-6 sm:p-8 flex flex-col justify-between text-white border border-slate-800 transition-colors duration-200">
                ...
                <div className="flex items-center gap-3 border-t border-slate-800/80 pt-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-blue-400 leading-none mt-1">Authorized Certiport Mentors</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-4">
                {values.map((v, i) => (
                  <div key={i} className="bg-slate-50/70 p-5 rounded-2xl border border-slate-200/70 hover:border-blue-500/25 transition-all duration-300 shadow-premium hover:shadow-premium-hover flex flex-col items-start gap-3">
                    <div className="p-3 bg-white border border-slate-100 rounded-xl shadow-sm shrink-0">
                      {v.icon}
                    </div>
                    <h3 className="font-bold text-slate-950 text-sm leading-snug">{v.title}</h3>
                    <p className="text-slate-500 text-xs sm:text-xs leading-relaxed">{v.desc}</p>
                  </div>
                ))}
              </div>
            </div>
      ...
      <section className="py-24 sm:py-32 bg-[#f8fafc] border-y border-slate-100/60 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-20 space-y-4">
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-950 tracking-tight leading-none">Hồ Sơ Năng Lực & Cam Kết</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 sm:p-7 rounded-2xl border border-slate-200/80 hover:border-blue-500/25 transition-all duration-300 shadow-premium hover:shadow-premium-hover flex gap-4 group">
              <div className="p-3 bg-blue-50 border border-blue-100 rounded-xl h-fit shrink-0 text-blue-600">
                <Award size={20} />
              </div>
              <div className="space-y-2">
                <h3 className="font-bold text-slate-900 text-sm sm:text-base leading-snug">100% Giảng Viên MOS Master</h3>
            ...
            <div className="bg-white p-6 sm:p-7 rounded-2xl border border-slate-200/80 hover:border-blue-500/25 transition-all duration-300 shadow-premium hover:shadow-premium-hover flex gap-4 group">
              ...
              <div className="space-y-2">
                <h3 className="font-bold text-slate-900 text-sm sm:text-base leading-snug">Tương Thích 18+ Trường ĐH</h3>
                <p className="text-slate-500 text-xs sm:text-sm leading-relaxed">
            ...
            <div className="bg-white p-6 sm:p-7 rounded-2xl border border-slate-200/80 hover:border-blue-500/25 transition-all duration-300 shadow-premium hover:shadow-premium-hover flex gap-4 group">
              ...
              <div className="space-y-2">
                <h3 className="font-bold text-slate-900 text-sm sm:text-base leading-snug">Cam Kết Bao Đỗ 100%</h3>
                <p className="text-slate-500 text-xs sm:text-sm leading-relaxed">
