...
export default function MockExamPage() {
  return (
    <div className="flex flex-col w-full bg-slate-50/40">
      ...
      {/* 1. Header Banner */}
      <section className="bg-white pt-10 pb-10 sm:pt-24 sm:pb-16 border-b border-slate-100 relative overflow-hidden">
      ...
      <section className="py-10 sm:py-16 bg-white border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-6 rounded-2xl bg-slate-50/70 border border-slate-200/80 space-y-3">
              <div className="w-10 h-10 rounded-xl bg-blue-100 text-blue-700 flex items-center justify-center font-bold">1</div>
              <h4 className="font-bold text-slate-900 text-base">Đề Thi Sát 99% Đề Thật</h4>
            ...
            <div className="p-6 rounded-2xl bg-slate-50/70 border border-slate-200/80 space-y-3">
              <div className="w-10 h-10 rounded-xl bg-blue-100 text-blue-700 flex items-center justify-center font-bold">2</div>
              <h4 className="font-bold text-slate-900 text-base">Biết Điểm & Giải Thích Ngay</h4>
              <p className="text-slate-600 text-xs sm:text-sm leading-relaxed">
            ...
            <div className="p-6 rounded-2xl bg-slate-50/70 border border-slate-200/80 space-y-3">
              <div className="w-10 h-10 rounded-xl bg-blue-100 text-blue-700 flex items-center justify-center font-bold">3</div>
              <h4 className="font-bold text-slate-900 text-base">Tư Vấn Lộ Trình 1:1 Miễn Phí</h4>
              <p className="text-slate-600 text-xs sm:text-sm leading-relaxed">
