...
export default function PricingPage() {
  ...
  return (
    <div className="flex flex-col w-full bg-slate-50/30">
      ...
      {/* 1. Header Banner */}
      <section className="bg-white pt-10 pb-10 sm:pt-20 sm:pb-14 border-b border-slate-100 relative overflow-hidden tech-grid-pattern">
      ...
      <section className="py-8 bg-blue-600 text-white shadow-md">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left">
          ...
          <Link
            href="/lien-he"
            className="shrink-0 px-6 py-2.5 rounded-full bg-white text-blue-900 font-bold text-xs uppercase tracking-wider hover:bg-slate-100 shadow-lg transition-all"
          >
            Nhận Mã Giảm Nhóm
          </Link>
        </div>
      ...
      <section className="py-8 sm:py-16 bg-[#f8fafc]">
      ...
      {/* 4. FAQ Section */}
      <section className="py-10 sm:py-16 bg-white border-t border-slate-100/60 relative">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          
          <div className="text-center mb-16 space-y-3">
            <div className="inline-flex items-center gap-1.5 border border-blue-100 bg-blue-50 px-3.5 py-1.5 rounded-full text-xs sm:text-xs font-bold tracking-wider uppercase text-blue-700">
              <HelpCircle size={13} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {faqs.map((faq, index) => (
              <div key={index} className="space-y-3 bg-slate-50/70 p-6 rounded-2xl border border-slate-200/70 hover:border-blue-500/25 transition-all duration-300 shadow-premium hover:shadow-premium-hover flex flex-col justify-between">
                <h3 className="font-bold text-slate-900 text-sm leading-snug flex items-start gap-2.5">
                  <div className="p-1 bg-white border border-slate-200/60 rounded-lg shadow-sm shrink-0 text-blue-500 mt-0.5">
