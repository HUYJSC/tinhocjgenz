...
import { ArrowLeft, Sparkles, ExternalLink, Save, CheckCircle2, XCircle, Send, RefreshCw, Share2, FileText, Eye, AlertCircle, Zap, Copy, Check } from "lucide-react";
  ...
  return (
    <div className="space-y-6 pb-12">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <span className="text-xs font-bold uppercase text-blue-600">{article.sourceName}</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        {/* ======================================================== */}
        <div className="lg:col-span-5 bg-white p-5 rounded-xl border border-slate-200/80 shadow-xs space-y-4 sticky top-20 max-h-[85vh] overflow-y-auto">
          ...
          <div className="space-y-2 text-xs">
            <div className="p-3 bg-slate-50 rounded-2xl border border-slate-100 space-y-1">
              <div className="text-xs text-slate-500 font-medium">Nguồn: <b>{article.sourceName}</b></div>
              {article.originalAuthor && (
                <div className="text-xs text-slate-500 font-medium">Tác giả: {article.originalAuthor}</div>
              )}
        ...
        <div className="lg:col-span-7 bg-white p-5 rounded-xl border border-slate-200/80 shadow-xs space-y-5">
          ...
          <div className="p-4 rounded-2xl bg-blue-50 border border-blue-200/70 space-y-2">
            ...
            {article.aiScoreBreakdown && (
              <div className="grid grid-cols-2 sm:grid-cols-5 gap-2 pt-2 text-xs font-bold text-slate-600 border-t border-blue-200/40">
          ...
          <div className="space-y-4 text-xs font-semibold">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-3.5 py-3 rounded-2xl border border-slate-200 focus:outline-none focus:border-blue-500 font-mono text-xs leading-relaxed"
              />
            </div>
      ...
      {showSocialModal && (
        <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white rounded-xl max-w-2xl w-full p-6 shadow-xl border border-slate-200 animate-in fade-in zoom-in-95 duration-200 space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-slate-100">
              <div className="flex items-center gap-2">
                  ...
                  <div key={post.platform} className="p-4 bg-slate-50 rounded-2xl border border-slate-200 space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className="flex items-center gap-1 text-xs font-bold text-blue-600 bg-blue-50 hover:bg-blue-100 px-2.5 py-1 rounded-lg transition-colors cursor-pointer"
                      >
